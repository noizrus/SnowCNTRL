...
enum Strings {
    ...
    private static let table: [LocKey: [AppLanguage: String]] = [
        ...
        .tireReminderWinterTitle: [
            ...
            .english: "Plan your winter tires",
            .spanish: "Prepara tus neumáticos de invierno",
        ],
        .tireReminderWinterBody: [
            .french: "Dans %DAYS% jours, les températures à %CITY% vont passer sous 0 °C pour de bon — le bon moment pour réserver ton changement de pneus d'hiver.",
            .english: "In %DAYS% days, temperatures in %CITY% are set to drop below 0°C for good — a good time to book your winter tire change.",
            .spanish: "En %DAYS% días, las temperaturas en %CITY% bajarán de 0 °C de forma sostenida — buen momento para reservar tu cambio a neumáticos de invierno.",
        ],
        .tireReminderSummerTitle: [
            .french: "Prépare tes pneus d'été",
            .english: "Plan your summer tires",
            .spanish: "Prepara tus neumáticos de verano",
        ],
        .tireReminderSummerBody: [
            .french: "Dans %DAYS% jours, les températures à %CITY% vont rester au-dessus de 7 °C — le bon moment pour remettre tes pneus d'été.",
            .english: "In %DAYS% days, temperatures in %CITY% are set to stay above 7°C — a good time to switch back to summer tires.",
            .spanish: "En %DAYS% días, las temperaturas en %CITY% se mantendrán sobre 7 °C — buen momento para volver a los neumáticos de verano.",
        ],
        .tireReminderDismiss: [
            .french: "OK",
            .english: "OK",
